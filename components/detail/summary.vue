<template>
  <dl class="m-sum-card">
    <dt>
      ...
      <span>{{ meta.biz_ext.rating?Number(meta.biz_ext.rating):rate }}分</span>
...
export default {
  ...
  computed: {
    rate: function() {
      // console.log(this.meta.biz_ext)
      return this.meta.biz_ext.rating?Number(this.meta.biz_ext.rating) : Math.floor(Math.random() * 5);
    }
  },
  methods: {
